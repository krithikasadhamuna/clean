...
from core.server.ingestion.log_ingester import LogIngester
...
class LogForwardingServer:
    ...
    def _initialize_topology_monitor(self):
        ...
        try:
            ...
            from core.topology.continuous_topology_monitor import ContinuousTopologyMonitor
    ...
    def _create_langserve_app(self) -> FastAPI:
        ...
        try:
            from core.langserve_api import soc_api
            app = soc_api.get_app()
